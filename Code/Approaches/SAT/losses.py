...
def get_loss(loss, labels=None, num_classes=2):
    if loss == 'ce':
        criterion = CrossEntropy()

    elif loss == 'sat':
        criterion = SelfAdaptiveTrainingCE(labels, num_classes=num_classes, momentum=0.9, es=0)
...
class SelfAdaptiveTrainingCE():
    def __init__(self, labels, num_classes=2, momentum=0.9, es=20):
